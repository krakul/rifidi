...
-Dorg.rifidi.llrp.encode.targetepc=000000000000000000000000 ^
-Dorg.rifidi.llrp.encode.tagmask=000000000000000000000000 ^
-Dorg.rifidi.llrp.encode.timeout=10000 ^
-Dorg.rifidi.llrp.encode.accesspwd=0 ^
-Dorg.rifidi.llrp.encode.oldaccesspwd=0 ^
-Dorg.rifidi.llrp.encode.killpwd=0 ^
-Dorg.rifidi.llrp.encode.killpwdlockprivilege=Read_Write ^
-Dorg.rifidi.llrp.encode.accesspwdlockprivilege=Read_Write ^
-Dorg.rifidi.llrp.encode.epclockprivilege=Read_Write ^
-Dorg.rifidi.llrp.encode.mqttqos ^
-Dorg.rifidi.llrp.encode.mqttbroker ^
-Dorg.rifidi.llrp.encode.mqttclientid=llrpEncodeId ^
-Dorg.rifidi.restlet.ssl.port=8183 ^
-Dorg.rifidi.restlet.ssl.enabled=false ^
...
-name Rifidi-server ^
--launcher.library plugins\org.eclipse.equinox.launcher.win32.win32.x86_64_1.1.300.v20150602-1417\eclipse_1611.dll ^
-exitdata 2c0024 ^
-vm java ^
